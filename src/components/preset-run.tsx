  ...
  return (
    <Dialog>
      <DialogTrigger asChild>
        <Button variant="secondary" onClick={() => setProgram(javascriptGenerator.workspaceToCode())}>Run</Button>
      </DialogTrigger>
      <DialogContent className="sm:max-w-[475px] h-fit flex flex-col">
        ...
        <div className="flex gap-5 justify-end">
          <DialogClose asChild>
            <Button type="submit" variant="outline">やめる</Button>
          </DialogClose>
          <Button type="submit" onClick={onClickRun}>実行する</Button>
        </div>
      </DialogContent>
    </Dialog>
  )
